...
export const SettingContainer = ({
  ...
  const onChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const newValue =
      id === "slippage" ? validateSlippage(value) : validateDeadline(value);
      ...
      >
        ...
        <Flex>
          ...
          >
            <Icon
              as={CheckIcon}
              color={slippageEffects.buttonDisabled ? "#A0A3AD" : "#FFFFFF"}
              boxSize={6}
            />
          </Button>
        </Flex>
        {slippageEffects.warnings &&
          (slippageEffects.color === "#DD3A44" ? (
            <RedWarningText
              label={slippageEffects.warnings}
      ...
      >
        ...
        <Flex>
          ...
          >
            <Icon
              as={CheckIcon}
              color={deadlineEffects.buttonDisabled ? "#A0A3AD" : "#FFFFFF"}
              boxSize={6}
            />
          </Button>
        </Flex>
        {deadlineEffects.color == "#DD3A44" && deadlineEffects.warnings && (
          <RedWarningText
            label={deadlineEffects.warnings}
            style={{ fontWeight: 400 }}
          />
        )}
      </Flex>
